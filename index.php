				...
				<!-- Intro -->
					<section id="top" class="one">
						<div class="container">
							...
							<header>
								<h2 class="alt">Thinking about selling <span class="blackblock"> 6208 Outlook Ave? </span> Let us help! This is YOUR personal team of professionals. Whether you have questions about purchasing or selling, you can rest assured when you have your own Team of Fast Agents backing you.</h2>
							</header>
				...
				<!-- Portfolio -->
					<section id="portfolio" class="two">
						<div class="container">
							...
							<p>When you list your property with Team Fast Agents, you receive a premium marketing plan with a personal touch.</p>
					...
					<section id="about" class="three">
						<div class="container">
							...
							<header>
								...
								<h3 style="color: #ecf0f1;">Properties sold within area of 6208 Outlook Ave</h3>
							</header>
							<div class="row">
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>6511 Simson St</strong></h3>
										<ul>
											<li>3 Bed - 1 Bath</li>
											<li>1,372 Sq Ft -  5,550 Lot</li>
											<li>List: 5/20/13 - Pending: 6/7/13</li>
											<li>List: $425,000 - SOLD $490,000</li>
										</ul>
									</article>
								</div>
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>3917 Edenvale Place</strong></h3>
										<ul>
											<li>3 Bed - 1 Bath</li>
											<li>1,146 Sq Ft - 6,192 Lot</li>
											<li>List: 10/7/13 - Pending: 10/21/13</li>
											<li>List: $359,500 - SOLD $350,000</li>
										</ul>
									</article>
								</div>
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>6216 Majestic Ave</strong></h3>
										<ul>
											<li>3 Bed - 1 Bath</li>
											<li>1,092 Sq Ft - 3,300 Lot</li>
											<li>List: 6/6/13 - Pending: 7/9/13</li>
											<li>List: $225,000 - SOLD $255,000</li>
										</ul>
									</article>
								</div>
							</div>
				...
				<!-- Contact -->
					<section id="contact" class="four">
						...
						<article class="4u">
							...
							<p>
								Kenny was ranked the #1 agent in Oakland for closed homes sold in Q3. He is a branded #fastagent who has inspired many in Alameda counties Real Estate industry with his cutting edge visions.
							</p>
						</article>
						<article class="4u ">
